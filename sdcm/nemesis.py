...
class Nemesis:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def _add_and_init_new_cluster_node(self, old_node_ip=None, timeout=HOUR_IN_SEC * 6):
        ...
        InfoEvent(message='Adding new node to cluster')
        ...
        InfoEvent(message='New Node is up and normal')
        return new_node
    ...
    def disrupt_grow_shrink_cluster(self):
        ...
        for _ in range(add_nodes_number):
            ...
            try:
                InfoEvent(message='ShrinkCluster - start decommissioning a node')
                self.cluster.decommission(self.target_node)
            finally:
                InfoEvent(message='ShrinkCluster - Done decommissioning a node')
    ...
    def disrupt_run_unique_sequence(self):
        InfoEvent(message='Starting mgmt_repair disruption')
        self.disrupt_mgmt_repair_cli()
        InfoEvent(message='Finished mgmt_repair disruption')
        time.sleep(180)
